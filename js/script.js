...
discount.addEventListener('click', function() {
    if (clickForm.classList.contains('active2')) {
        clickForm.classList.remove('active2')
        clickForm.classList.add('active1')
    } else {
        clickForm.classList.remove('active1')
        clickForm.classList.add('active2')
    }
})
