...
<?php include('sideForm.php') ?>
  ...
  <div class="page animated" style="animation-duration: 500ms;">
    ...
    <header class="section page-header page-header-2 section-custom-1-ally">
          ...
          <div class="rd-navbar-main-outer">
            ...
            <div class="rd-navbar-nav-wrap toggle-original-elements">
              ...
              <ul class="rd-navbar-nav" style="margin: auto;">
                ...
                <li class="rd-nav-item active"><a class="rd-nav-link" href="onlineCourse.php">Online Course</a>
                </li>
      ...
      <div class="jumbotron-3">
        <div class="parallax-container jumbotron-3-inner context-dark" data-parallax-img="images/bg-image-01.jpg">
          <div class="material-parallax parallax"><img src="images/bg-image-01.jpg" alt="" style="display: block; transform: translate3d(-50%, 104px, 0px);"></div>
          <div class="material-parallax parallax"><img src="images/bg-image-01.jpg" alt="" style="display: block; transform: translate3d(-50%, 173px, 0px);"></div>
          <div class="material-parallax parallax"><img src="images/bg-image-01.jpg" alt="" style="display: block; transform: translate3d(-50%, 189px, 0px);"></div>
          <div class="material-parallax parallax"><img src="images/bg-image-01.jpg" alt="" style="display: block; transform: translate3d(-50%, 158px, 0px);"></div>
          <div class="parallax-content">
            <div class="container">
              <div class="row">
                <div class="col-md-8 col-lg-7 col-xl-7">
                  <div class="jumbotron-3-text wow fadeIn" data-wow-delay=".1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                  ...
                  <div class="unit jumbotron-3-title wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
                    <div class="unit-body">
                      <ul>
                        <li>
                          <h3>1. lorem Epsum</h3>
          ...
          <div class="col-lg-5 col-xl-5">
            <div class="section-custom-1-block box-decoration">
              <div class="row row-40">
                ...
                <div class="col-md-6 col-lg-12">
                  <h5 class="text-uppercase wow fadeIn" style="visibility: visible; animation-name: fadeIn;">Lots of
                    Happy Students</h5>
                  <p class="text-gray-500 mt-30 wow fadeIn" data-wow-delay=".05s" style="visibility: visible; animation-delay: 0.05s; animation-name: fadeIn;">We have over 4 thousand
                    students</p>
        ...
        <div class="row row-30 row-sm-50 justify-content-center justify-content-lg-between">
          ...
          <div class="col-lg-4 offset-top-96">
            <div class="row row-40 row-md-50 row-xxl-80">
              <div class="col-md-6 col-lg-12">
                <article class="box-8 mt-30 mt-xl-60 wow fadeIn" data-wow-delay=".1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                  <ul class="list-pricing">
                    <li><a href="#"><span class="list-pricing-title">Language for Business</span><span>$45</span></a>
                    </li>
                    ...
                    <li><a href="#"><span class="list-pricing-title">French for Beginners</span><span>$32</span></a>
                    </li>
                  </ul>
                </article>
              </div>
              <div class="col-md-6 col-lg-12">
                <h2 class="text-uppercase font-weight-bold text-center text-sm-left wow fadeIn" style="visibility: visible; animation-name: fadeIn;">why choose us</h2>
                <ul class="row list-group-2 row-13 row-md-30 mt-20 mt-xl-40">
                  <li class="col-sm-6 col-md-12 wow fadeIn" data-wow-delay=".05s" style="visibility: visible; animation-delay: 0.05s; animation-name: fadeIn;">
                  ...
                  <li class="col-sm-6 col-md-12 wow fadeIn" data-wow-delay=".1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                    <article class="lg-2-item">
                  ...
                  <li class="col-sm-6 col-md-12 wow fadeIn" data-wow-delay=".15s" style="visibility: hidden; animation-delay: 0.15s; animation-name: none;">
                    <article class="lg-2-item">
          ...
          <li class="col-sm-6 col-lg-3">
            <article class="lg-1-item">
              ...
              <div class="lg-1-item-main">
                ...
                <p>Lura, capio, et diatria. Mori recte ducunt ad alter plasmator. Experimentum sapienter ducunt ad
                  audax.</p>
              </div>
            </article>
          </li>
          ...
          <li class="col-sm-6 col-lg-3">
            <article class="lg-1-item">
              ...
              <div class="lg-1-item-main">
                ...
                <p>Cur nixus mori? Pol. Sunt hippotoxotaes convertam festus, brevis buboes. Brevis terror nunquam amors.
                </p>
              </div>
            </article>
          </li>
            ...
            <blockquote class="quote-classic">
              <div class="quote-classic-inner">
                <div class="quote-classic-header">
                  ...
                  <div class="quote-classic-links"><a class="quote-classic-social-link mdi mdi-facebook" href="#"></a>
                  </div>
                </div>
                <div class="quote-classic-text">
                  <p>Eget gravida cum sociis natoque penatibus et magnis dis parturient. Libero enim sed faucibus turpis
                    in</p>
                </div>
          ...
          <div class="col-md-6">
            ...
            <blockquote class="quote-classic">
              <div class="quote-classic-inner">
                ...
                <div class="quote-classic-text">
                  <p>Purus in mollis nunc sed id semper risus. Et netus et malesuada fames ac turpis. Hendrerit gravida
          ...
          <div class="col-md-6">
            ...
            <blockquote class="quote-classic">
              <div class="quote-classic-inner">
                ...
                <div class="quote-classic-text">
                  <p>Felis eget nunc lobortis mattis aliquam faucibus purus in massa. Malesuada pellentesque elit eget
                    gravida</p>
                </div>
                <time class="quote-classic-time" datetime="2019">Mar 21, 2019</time>
              </div>
    ...
    <section class="section bg-color-gray-100">
      <div class="range">
        <div class="cell-lg-12 cell-xl-12 cell-xxl-12" style="
    display: flex;
    justify-content: center;
    align-items: center;
">
          <div class="cell-inner section-lg text-center text-sm-left" style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
            <h3 class="title-costume">Meet Our Team</h3>
            <p>Duis aute irure dolor in reprehenderit in voluptate velit</p>
            <!-- Owl Carousel-->
            <div class="owl-carousel owl-1 mt-lg-50 owl-loaded" data-items="1" data-sm-items="2" data-md-items="3" data-lg-items="2" data-xl-items="3" data-dots="true" data-nav="false" data-stage-padding="0" data-loop="false" data-margin="30" data-mouse-drag="false" style="">
              <!-- Profile Classic-->
              ...
              <div class="owl-stage-outer" style="">
                <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1684px; display: flex; justify-content: center; align-items: center; padding-top: 0px; padding-bottom: 0px;">
    ...
    <section class="section section-xl context-dark bg-image bg-overlay-1 text-center" style="background-image: url(images/bg-image-3.jpg);">
      <div class="container">
        <h2 class="text-uppercase font-weight-bold wow fadeIn" style="visibility: hidden; animation-name: none;">Join
          Our Newsletter</h2>
        <h3 class="font-weight-regular mt-md-20 mt-lg-40 wow fadeIn" data-wow-delay=".025s" style="visibility: hidden; animation-delay: 0.025s; animation-name: none;">Subscribe to our newsletter to
          receive the latest news &amp; updates.</h3>
        <div class="block-2 block-centered mt-30 mt-lg-60 wow fadeIn" data-wow-delay=".05s" style="visibility: hidden; animation-delay: 0.05s; animation-name: none;">
          <form class="rd-form rd-mailform form-inline form-lg" data-form-output="form-output-global" data-form-type="subscribe" method="post" action="bat/rd-mailform.php" novalidate="novalidate">
            <div class="form-wrap form-wrap-icon has-error">
              <input class="form-input form-control-has-validation" id="subscribe-form-email" type="email" name="email" data-constraints="@Email @Required"><span class="form-validation"></span><span class="form-validation"></span><span class="form-validation">The text field is required.</span><span class="form-validation">The text field is required.</span>
      ...
      <div class="footer-classic-main">
        <div class="container">
          <div class="footer-classic-layout justify-content-sm-around justify-content-md-between">
            <div class="footer-classic-layout-item"><a class="brand" href="index.html"><img class="brand-logo-dark" src="Logo-01.png" alt="" width="200"></a>
                  ...
                  <div class="owl-carousel owl-loaded" data-items="1" data-dots="false" data-nav="false" data-stage-padding="0" data-loop="true" data-margin="30" data-nav-custom="#footer-owl-nav" data-animation-in="fadeIn" data-animation-out="fadeOut" data-mouse-drag="false" style="">
                    ...
                    <div class="owl-stage-outer">
                      <div class="owl-stage" style="transform: translate3d(-940px, 0px, 0px); transition: all 0s ease 0s; width: 3290px;">
                        ...
                        <div class="owl-item active" style="width: 440px; margin-right: 30px;">
                          <blockquote class="quote-light quote-light-sm">
                            <div class="icon linearicons-quote-open text-primary icon-md"></div>
                            <div class="quote-light-main">
                              <div class="quote-light-text">
